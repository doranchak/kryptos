...
- **31 cipher types**: simple substitution, homophonic substitution,
  **Chaocipher**, autokey, columnar transposition, double columnar
  ...
  Vigenère, Enigma, Beaufort, Porta, Playfair, Hill, scytale.
...
- **Visualizer mode**: pick a cipher, load the built-in sample (or type your
  ...
  the tab used for that letter picked out.
