...
`scripts/test_ciphers.js`). Enigma implements the standard Wehrmacht Enigma
I rotor wirings (I-V), reflectors B/C, ring settings, and the classic
double-step anomaly; it's internally self-reciprocal and structurally
standard, but wasn't checked against an external known-ciphertext vector.
